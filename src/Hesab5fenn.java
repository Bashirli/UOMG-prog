 ...
 * @author Bashirli
 */
public class Hesab5fenn extends javax.swing.JFrame {

    /**
     * Creates new form Hesab5fenn
     */
    public Hesab5fenn() {
    ...
    return;
      ...
      if(error_tapma(Kredit1.getText())==0||error_tapma(Kredit2.getText())==0||error_tapma(Kredit3.getText())==0||error_tapma(Kredit4.getText())==0){
        ...
        double balcemi=Integer.parseInt(Bal1.getText())*Integer.parseInt(Kredit1.getText())  +Integer.parseInt(Bal2.getText())*Integer.parseInt(Kredit2.getText())
                +Integer.parseInt(Bal3.getText())*Integer.parseInt(Kredit3.getText())+Integer.parseInt(Bal4.getText())*Integer.parseInt(Kredit4.getText())+Integer.parseInt(Bal5.getText())*Integer.parseInt(Kredit5.getText());
      double kreditcemi=Integer.parseInt(Kredit1.getText())+Integer.parseInt(Kredit2.getText())
                +Integer.parseInt(Kredit3.getText())+Integer.parseInt(Kredit4.getText()) +Integer.parseInt(Kredit5.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hesab5fenn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hesab5fenn().setVisible(true);
            }
        });
    }
