 ...
 * @author Bashirli
 */
public class Hesab6fenn extends javax.swing.JFrame {

    /**
     * Creates new form Hesab6fenn
     */
    public Hesab6fenn() {
    ...
    private void initComponents() {
        ...
        Bal6 = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Ortalama Hesabla");
        ...
        jLabel13.setText("Kredit");

        jLabel14.setText("Bal");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(Bal5, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35)
                .addComponent(jLabel12)
                .addGap(26, 26, 26)
                .addComponent(Kredit5, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(28, 28, 28)
                .addComponent(jLabel14)
                .addGap(18, 18, 18)
                .addComponent(Bal6, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35)
                .addComponent(jLabel13)
                .addGap(26, 26, 26)
                .addComponent(Kredit6, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(127, 127, 127)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Bal5, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Kredit5, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(7, 7, 7)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel11)
                ...
                .addGap(12, 12, 12)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Bal6, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Kredit6, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(7, 7, 7)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel14)
    ...
    private void HesablaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HesablaActionPerformed
        ...
        if(error_tapma(Bal1.getText())==0||error_tapma(Bal2.getText())==0||error_tapma(Bal3.getText())==0||error_tapma(Bal4.getText())==0||error_tapma(Bal5.getText())==0||error_tapma(Bal6.getText())==0){
    return;
}
      if(error_tapma(Kredit1.getText())==0||error_tapma(Kredit2.getText())==0||error_tapma(Kredit3.getText())==0||error_tapma(Kredit4.getText())==0||error_tapma(Kredit5.getText())==0||error_tapma(Kredit6.getText())==0){
          return;
      }
        ...
        double balcemi=Integer.parseInt(Bal1.getText())*Integer.parseInt(Kredit1.getText())  +Integer.parseInt(Bal2.getText())*Integer.parseInt(Kredit2.getText())
                +Integer.parseInt(Bal3.getText())*Integer.parseInt(Kredit3.getText())+Integer.parseInt(Bal4.getText())*Integer.parseInt(Kredit4.getText())+Integer.parseInt(Bal5.getText())*Integer.parseInt(Kredit5.getText())+Integer.parseInt(Bal6.getText())*Integer.parseInt(Kredit6.getText());
      double kreditcemi=Integer.parseInt(Kredit1.getText())+Integer.parseInt(Kredit2.getText())
                +Integer.parseInt(Kredit3.getText())+Integer.parseInt(Kredit4.getText()) +Integer.parseInt(Kredit5.getText())+Integer.parseInt(Kredit6.getText());
 ...
 public int error_tapma(String setr){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hesab6fenn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hesab6fenn().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField Bal6;
    ...
    private javax.swing.JTextField Kredit5;
    private javax.swing.JTextField Kredit6;
